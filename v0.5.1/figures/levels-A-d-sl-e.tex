...
\node (Ad0p4l) [below=of Ad1p3-1-1] {\\4};
\node (Ad0p4) [below=0 of Ad0p4l.south, nzsty] {4.4};
\draw (Ad1p3-1-1.center) -- (Ad0p4l.north) node [midway, fill=white] {[1]};
\node (Ad0p5l) [below=of Ad1p3-1-3] {\\5};
\node (Ad0p5) [below=0 of Ad0p5l.south, nzsty] {5.5};
\draw (Ad1p3-1-3.center) -- (Ad0p5l.north) node [midway, fill=white] {[3]};
