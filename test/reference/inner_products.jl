            ...
            for j = 1:j_stop
                ...
                if phase_stop >= phase_start
                    ...
                    while k <= phase_stop
                        ...
                        k_2 = k
                        if A_lvl_5_i == phase_stop_2 && A_lvl_2_i == phase_stop_2
                ...
                k_start = k
                phase_start_3 = k_start
                phase_stop_3 = (min)(A_lvl_5_i1, k_stop)
                if phase_stop_3 >= phase_start_3
                    k_4 = k
                    k = phase_stop_3 + 1
                end
                k_start = k
                phase_start_4 = k_start
                phase_stop_4 = (min)(A_lvl_2_i1, k_stop)
                if phase_stop_4 >= phase_start_4
                    k_5 = k
                    k = phase_stop_4 + 1
                end
                k_start = k
                phase_start_5 = k_start
                phase_stop_5 = k_stop
