            ...
            if phase_stop >= phase_start
                ...
                elseif phase_stop == A_i1
                    ...
                    while i <= phase_stop - 1
                        i_start_2 = i
                        phase_stop_2 = (min)(B_i1, phase_stop - 1)
                        i_3 = i
                ...
                elseif phase_stop == B_i1
                    ...
                    while i <= phase_stop - 1
                        i_start_4 = i
                        phase_stop_4 = (min)(A_i1, phase_stop - 1)
                        i_9 = i
                        if A_i1 == phase_stop_4
                            i_10 = phase_stop_4
                            push!(C.idx, C_I)
                            push!(C.val, zero(Float64))
                            C_p += 1
                    ...
                    A_i1 = A.idx[A_p]
                    i_start_5 = i
                    phase_start_5 = i_start_5
                    phase_stop_5 = (min)(A_i1, phase_stop)
                    i_11 = i
                    if A_i1 == phase_stop_5
                    ...
                    while i <= phase_stop
                        ...
                        i_15 = i
                        if B_i1 == phase_stop_6 && A_i1 == phase_stop_6
                            i_16 = phase_stop_6
                            push!(C.idx, C_I)
                            push!(C.val, zero(Float64))
                            C_p += 1
