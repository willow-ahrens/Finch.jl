begin
    ...
    for i = 1:A_lvl.I
            ...
            while j <= phase_stop
                ...
                if A_lvl_2_i == phase_stop_2
                    ...
                    if B_lvl_qos > B_lvl_qos_stop
                        ...
                        (Finch.resize_if_smaller!)(B_lvl.idx, B_lvl_qos_stop)
                        resize_if_smaller!(B_lvl_2.val, B_lvl_qos_stop)
                        fill_range!(B_lvl_2.val, 0.0, B_lvl_qos, B_lvl_qos_stop)
                    end
                    B_lvl_2_dirty = false
                    B_lvl_2_val_2 = B_lvl_2.val[B_lvl_qos]
                    B_lvl_2_dirty = true
                    B_lvl_2_dirty = true
                    B_lvl_2_val_2 = (+)(A_lvl_3_val_2, B_lvl_2_val_2)
                    B_lvl_2.val[B_lvl_qos] = B_lvl_2_val_2
                    if B_lvl_2_dirty
                        B_lvl_dirty = true
                        B_lvl.idx[B_lvl_qos] = j_3
                        B_lvl_qos += 1
                    end
                    A_lvl_2_q += 1
                else
        ...
        B_lvl.pos[1 + 1] = (B_lvl_qos - B_lvl_qos_fill) - 1
        B_lvl_qos_fill = B_lvl_qos - 1
    end
    for p = 2:1 + 1
    ...
    qos = B_lvl.pos[end] - 1
    resize!(B_lvl.idx, qos)
    resize!(B_lvl_2.val, qos)
    (B = Fiber((Finch.SparseListLevel){Int64}(A_lvl_2.I, B_lvl.pos, B_lvl.idx, B_lvl_2), (Environment)(; )),)
end
