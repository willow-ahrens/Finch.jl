@testset "constructors" begin
    ...
    @testset "Finch.SparseBytemapLevel constructors" begin
        ref = Fiber(SparseBytemap{Int64}(4, [1, 1], Bool[0, 0, 0, 0], Tuple{Int64, Int64}[], Base.RefValue{Int64}(0), Element{0.0}(Float64[])))
        res = Fiber(Finch.SparseBytemapLevel(4, [1, 1], Bool[0, 0, 0, 0], Tuple{Int64, Int64}[], Base.RefValue{Int64}(0), Element{0.0}(Float64[])))
        @test isstructequal(res, ref)
        res = Fiber(Finch.SparseBytemapLevel(4, Element{0.0}(Float64[])))
        @test isstructequal(res, ref)
        res = Fiber(Finch.SparseBytemapLevel{Int64}(4, [1, 1], Bool[0, 0, 0, 0], Tuple{Int64, Int64}[], Base.RefValue{Int64}(0), Element{0.0}(Float64[])))
        @test isstructequal(res, ref)
        res = Fiber(Finch.SparseBytemapLevel{Int64}(4, Element{0.0}(Float64[])))
        @test isstructequal(res, ref)
        res = Fiber(Finch.SparseBytemapLevel{Int64, Int64}(4, [1, 1], Bool[0, 0, 0, 0], Tuple{Int64, Int64}[], Base.RefValue{Int64}(0), Element{0.0}(Float64[])))
        @test isstructequal(res, ref)
        res = Fiber(Finch.SparseBytemapLevel{Int64, Int64}(4, Element{0.0}(Float64[])))
        @test isstructequal(res, ref)
    end
    @testset "Finch.SparseBytemapLevel{Int8} constructors" begin
        ref = Fiber(SparseBytemap{Int8}(4, [1, 1], Bool[0, 0, 0, 0], Tuple{Int64, Int8}[], Base.RefValue{Int64}(0), Element{0.0}(Float64[])))
        res = Fiber(Finch.SparseBytemapLevel{Int8}(4, [1, 1], Bool[0, 0, 0, 0], Tuple{Int64, Int8}[], Base.RefValue{Int64}(0), Element{0.0}(Float64[])))
        @test isstructequal(res, ref)
        res = Fiber(Finch.SparseBytemapLevel{Int8}(4, Element{0.0}(Float64[])))
        @test isstructequal(res, ref)
        res = Fiber(Finch.SparseBytemapLevel{Int8, Int64}(4, [1, 1], Bool[0, 0, 0, 0], Tuple{Int64, Int8}[], Base.RefValue{Int64}(0), Element{0.0}(Float64[])))
        @test isstructequal(res, ref)
    ...
    @testset "Finch.SparseBytemapLevel constructors" begin
        ref = Fiber(SparseBytemap{Int64}(6, [1, 3], Bool[0, 1, 0, 1, 0, 0], [(1, 2), (1, 4)], Base.RefValue{Int64}(2), Element{0.0}([0.0, 1.0])))
        res = Fiber(Finch.SparseBytemapLevel(6, [1, 3], Bool[0, 1, 0, 1, 0, 0], [(1, 2), (1, 4)], Base.RefValue{Int64}(2), Element{0.0}([0.0, 1.0])))
        @test isstructequal(res, ref)
        res = Fiber(Finch.SparseBytemapLevel{Int64}(6, [1, 3], Bool[0, 1, 0, 1, 0, 0], [(1, 2), (1, 4)], Base.RefValue{Int64}(2), Element{0.0}([0.0, 1.0])))
        @test isstructequal(res, ref)
        res = Fiber(Finch.SparseBytemapLevel{Int64, Int64}(6, [1, 3], Bool[0, 1, 0, 1, 0, 0], [(1, 2), (1, 4)], Base.RefValue{Int64}(2), Element{0.0}([0.0, 1.0])))
        @test isstructequal(res, ref)
    end
    @testset "Finch.SparseBytemapLevel{Int8} constructors" begin
        ref = Fiber(SparseBytemap{Int8}(6, [1, 3], Bool[0, 1, 0, 1, 0, 0], Tuple{Int64, Int8}[(1, 2), (1, 4)], Base.RefValue{Int64}(2), Element{0.0}([0.0, 1.0])))
        res = Fiber(Finch.SparseBytemapLevel{Int8}(6, [1, 3], Bool[0, 1, 0, 1, 0, 0], Tuple{Int64, Int8}[(1, 2), (1, 4)], Base.RefValue{Int64}(2), Element{0.0}([0.0, 1.0])))
        @test isstructequal(res, ref)
        res = Fiber(Finch.SparseBytemapLevel{Int8, Int64}(6, [1, 3], Bool[0, 1, 0, 1, 0, 0], Tuple{Int64, Int8}[(1, 2), (1, 4)], Base.RefValue{Int64}(2), Element{0.0}([0.0, 1.0])))
        @test isstructequal(res, ref)
    end
    @testset "Finch.SparseBytemapLevel{Int8, Int8} constructors" begin
    ...
    @testset "Finch.DenseLevel constructors" begin
        ref = Fiber(Dense{Int64}(6, Element{0.0}([0.0, 2.0, 2.0, 0.0, 3.0, 3.0])))
        res = Fiber(Finch.DenseLevel(6, Element{0.0}([0.0, 2.0, 2.0, 0.0, 3.0, 3.0])))
        @test isstructequal(res, ref)
        res = Fiber(Finch.DenseLevel{Int64}(6, Element{0.0}([0.0, 2.0, 2.0, 0.0, 3.0, 3.0])))
        @test isstructequal(res, ref)
    end
    @testset "Finch.DenseLevel{Int8} constructors" begin
    ...
    @testset "Finch.SparseListLevel constructors" begin
        ref = Fiber(SparseList{Int64}(6, [1, 5], [2, 3, 5, 6], Element{0.0}([2.0, 2.0, 3.0, 3.0])))
        res = Fiber(Finch.SparseListLevel(6, [1, 5], [2, 3, 5, 6], Element{0.0}([2.0, 2.0, 3.0, 3.0])))
        @test isstructequal(res, ref)
        res = Fiber(Finch.SparseListLevel{Int64}(6, [1, 5], [2, 3, 5, 6], Element{0.0}([2.0, 2.0, 3.0, 3.0])))
        @test isstructequal(res, ref)
        res = Fiber(Finch.SparseListLevel{Int64, Int64}(6, [1, 5], [2, 3, 5, 6], Element{0.0}([2.0, 2.0, 3.0, 3.0])))
        @test isstructequal(res, ref)
    end
    @testset "Finch.SparseListLevel{Int8} constructors" begin
        ...
        @test isstructequal(res, ref)
        res = Fiber(Finch.SparseListLevel{Int8, Int64}(6, [1, 5], Int8[2, 3, 5, 6], Element{0.0}([2.0, 2.0, 3.0, 3.0])))
        @test isstructequal(res, ref)
    end
    @testset "Finch.SparseListLevel{Int8, Int8} constructors" begin
    ...
    @testset "Finch.SparseVBLLevel constructors" begin
        ref = Fiber(SparseVBL{Int64}(6, [1, 3], [3, 6, 559108, 2], [1, 3, 5], Element{0.0}([2.0, 2.0, 3.0, 3.0])))
        res = Fiber(Finch.SparseVBLLevel(6, [1, 3], [3, 6, 559108, 2], [1, 3, 5], Element{0.0}([2.0, 2.0, 3.0, 3.0])))
        @test isstructequal(res, ref)
        res = Fiber(Finch.SparseVBLLevel{Int64}(6, [1, 3], [3, 6, 559108, 2], [1, 3, 5], Element{0.0}([2.0, 2.0, 3.0, 3.0])))
        @test isstructequal(res, ref)
        res = Fiber(Finch.SparseVBLLevel{Int64, Int64}(6, [1, 3], [3, 6, 559108, 2], [1, 3, 5], Element{0.0}([2.0, 2.0, 3.0, 3.0])))
        @test isstructequal(res, ref)
    end
    @testset "Finch.SparseVBLLevel{Int8} constructors" begin
        ref = Fiber(SparseVBL{Int8}(6, [1, 3], Int8[3, 6, 0, 0], [1, 3, 5], Element{0.0}([2.0, 2.0, 3.0, 3.0])))
        res = Fiber(Finch.SparseVBLLevel{Int8}(6, [1, 3], Int8[3, 6, 0, 0], [1, 3, 5], Element{0.0}([2.0, 2.0, 3.0, 3.0])))
        @test isstructequal(res, ref)
        res = Fiber(Finch.SparseVBLLevel{Int8, Int64}(6, [1, 3], Int8[3, 6, 0, 0], [1, 3, 5], Element{0.0}([2.0, 2.0, 3.0, 3.0])))
        @test isstructequal(res, ref)
    end
    @testset "Finch.SparseVBLLevel{Int8, Int8} constructors" begin
        ref = Fiber(SparseVBL{Int8}(6, Int8[1, 3], Int8[3, 6, 0, 0], Int8[1, 3, 5], Element{0.0}([2.0, 2.0, 3.0, 3.0])))
        res = Fiber(Finch.SparseVBLLevel{Int8, Int8}(6, Int8[1, 3], Int8[3, 6, 0, 0], Int8[1, 3, 5], Element{0.0}([2.0, 2.0, 3.0, 3.0])))
        @test isstructequal(res, ref)
    end
    @testset "Finch.SparseBytemapLevel constructors" begin
        ref = Fiber(SparseBytemap{Int64}(6, [1, 5], Bool[0, 1, 1, 0, 1, 1], [(1, 2), (1, 3), (1, 5), (1, 6)], Base.RefValue{Int64}(4), Element{0.0}([0.0, 2.0, 2.0, 0.0])))
        res = Fiber(Finch.SparseBytemapLevel(6, [1, 5], Bool[0, 1, 1, 0, 1, 1], [(1, 2), (1, 3), (1, 5), (1, 6)], Base.RefValue{Int64}(4), Element{0.0}([0.0, 2.0, 2.0, 0.0])))
        @test isstructequal(res, ref)
        res = Fiber(Finch.SparseBytemapLevel{Int64}(6, [1, 5], Bool[0, 1, 1, 0, 1, 1], [(1, 2), (1, 3), (1, 5), (1, 6)], Base.RefValue{Int64}(4), Element{0.0}([0.0, 2.0, 2.0, 0.0])))
        @test isstructequal(res, ref)
        res = Fiber(Finch.SparseBytemapLevel{Int64, Int64}(6, [1, 5], Bool[0, 1, 1, 0, 1, 1], [(1, 2), (1, 3), (1, 5), (1, 6)], Base.RefValue{Int64}(4), Element{0.0}([0.0, 2.0, 2.0, 0.0])))
        @test isstructequal(res, ref)
    end
    @testset "Finch.SparseBytemapLevel{Int8} constructors" begin
        ref = Fiber(SparseBytemap{Int8}(6, [1, 5], Bool[0, 1, 1, 0, 1, 1], Tuple{Int64, Int8}[(1, 2), (1, 3), (1, 5), (1, 6)], Base.RefValue{Int64}(4), Element{0.0}([0.0, 2.0, 2.0, 0.0])))
        res = Fiber(Finch.SparseBytemapLevel{Int8}(6, [1, 5], Bool[0, 1, 1, 0, 1, 1], Tuple{Int64, Int8}[(1, 2), (1, 3), (1, 5), (1, 6)], Base.RefValue{Int64}(4), Element{0.0}([0.0, 2.0, 2.0, 0.0])))
        @test isstructequal(res, ref)
        res = Fiber(Finch.SparseBytemapLevel{Int8, Int64}(6, [1, 5], Bool[0, 1, 1, 0, 1, 1], Tuple{Int64, Int8}[(1, 2), (1, 3), (1, 5), (1, 6)], Base.RefValue{Int64}(4), Element{0.0}([0.0, 2.0, 2.0, 0.0])))
        @test isstructequal(res, ref)
    end
    @testset "Finch.SparseBytemapLevel{Int8, Int8} constructors" begin
    ...
    @testset "Finch.RepeatRLELevel{0.0} constructors" begin
        ref = Fiber(RepeatRLE{0.0, Int64}(0, [1, 1], Int64[], Float64[]))
        res = Fiber(Finch.RepeatRLELevel{0.0}(0, [1, 1], Int64[], Float64[]))
        @test isstructequal(res, ref)
        res = Fiber(Finch.RepeatRLELevel{0.0}(0))
        @test isstructequal(res, ref)
        res = Fiber(Finch.RepeatRLELevel{0.0, Int64}(0, [1, 1], Int64[], Float64[]))
        @test isstructequal(res, ref)
        res = Fiber(Finch.RepeatRLELevel{0.0, Int64}(0))
        @test isstructequal(res, ref)
        res = Fiber(Finch.RepeatRLELevel{0.0, Int64, Int64}(0, [1, 1], Int64[], Float64[]))
        @test isstructequal(res, ref)
        res = Fiber(Finch.RepeatRLELevel{0.0, Int64, Int64}(0))
        @test isstructequal(res, ref)
        res = Fiber(Finch.RepeatRLELevel{0.0, Int64, Int64, Float64}(0, [1, 1], Int64[], Float64[]))
        @test isstructequal(res, ref)
    ...
    @testset "Finch.RepeatRLELevel{0.0, Int8} constructors" begin
        ...
        @test isstructequal(res, ref)
        res = Fiber(Finch.RepeatRLELevel{0.0, Int8, Int64}(0, [1, 1], Int8[], Float64[]))
        @test isstructequal(res, ref)
        res = Fiber(Finch.RepeatRLELevel{0.0, Int8, Int64}(0))
        @test isstructequal(res, ref)
        res = Fiber(Finch.RepeatRLELevel{0.0, Int8, Int64, Float64}(0, [1, 1], Int8[], Float64[]))
        @test isstructequal(res, ref)
        res = Fiber(Finch.RepeatRLELevel{0.0, Int8, Int64, Float64}(0))
        @test isstructequal(res, ref)
    end
    ...
    @testset "Finch.RepeatRLELevel{0.0} constructors" begin
        ref = Fiber(RepeatRLE{0.0, Int64}(4, [1, 2], [4], [0.0]))
    ...
    @testset "Finch.RepeatRLELevel{0.0, Int8} constructors" begin
        ...
        @test isstructequal(res, ref)
        res = Fiber(Finch.RepeatRLELevel{0.0, Int8, Int64}(4, [1, 2], Int8[4], [0.0]))
        @test isstructequal(res, ref)
        res = Fiber(Finch.RepeatRLELevel{0.0, Int8, Int64}(4))
        @test isstructequal(res, ref)
        res = Fiber(Finch.RepeatRLELevel{0.0, Int8, Int64, Float64}(4, [1, 2], Int8[4], [0.0]))
        @test isstructequal(res, ref)
        res = Fiber(Finch.RepeatRLELevel{0.0, Int8, Int64, Float64}(4))
        @test isstructequal(res, ref)
    end
    @testset "Finch.RepeatRLELevel{0.0, Int8, Int8} constructors" begin
    ...
    @testset "Finch.RepeatRLELevel{0.0} constructors" begin
        ref = Fiber(RepeatRLE{0.0, Int64}(6, [1, 3], [1, 6], [0.0, 1.0]))
        res = Fiber(Finch.RepeatRLELevel{0.0}(6, [1, 3], [1, 6], [0.0, 1.0]))
        @test isstructequal(res, ref)
        res = Fiber(Finch.RepeatRLELevel{0.0, Int64}(6, [1, 3], [1, 6], [0.0, 1.0]))
        @test isstructequal(res, ref)
        res = Fiber(Finch.RepeatRLELevel{0.0, Int64, Int64}(6, [1, 3], [1, 6], [0.0, 1.0]))
        @test isstructequal(res, ref)
        res = Fiber(Finch.RepeatRLELevel{0.0, Int64, Int64, Float64}(6, [1, 3], [1, 6], [0.0, 1.0]))
        @test isstructequal(res, ref)
    end
    @testset "Finch.RepeatRLELevel{0.0, Int8} constructors" begin
        ...
        @test isstructequal(res, ref)
        res = Fiber(Finch.RepeatRLELevel{0.0, Int8, Int64}(6, [1, 3], Int8[1, 6], [0.0, 1.0]))
        @test isstructequal(res, ref)
        res = Fiber(Finch.RepeatRLELevel{0.0, Int8, Int64, Float64}(6, [1, 3], Int8[1, 6], [0.0, 1.0]))
        @test isstructequal(res, ref)
    end
    @testset "Finch.RepeatRLELevel{0.0, Int8, Int8} constructors" begin
    ...
    @testset "Finch.RepeatRLELevel{0.0} constructors" begin
        ref = Fiber(RepeatRLE{0.0, Int64}(6, [1, 4], [1, 4, 6], [0.0, 2.0, 3.0]))
        res = Fiber(Finch.RepeatRLELevel{0.0}(6, [1, 4], [1, 4, 6], [0.0, 2.0, 3.0]))
        @test isstructequal(res, ref)
        res = Fiber(Finch.RepeatRLELevel{0.0, Int64}(6, [1, 4], [1, 4, 6], [0.0, 2.0, 3.0]))
        @test isstructequal(res, ref)
        res = Fiber(Finch.RepeatRLELevel{0.0, Int64, Int64}(6, [1, 4], [1, 4, 6], [0.0, 2.0, 3.0]))
        @test isstructequal(res, ref)
        res = Fiber(Finch.RepeatRLELevel{0.0, Int64, Int64, Float64}(6, [1, 4], [1, 4, 6], [0.0, 2.0, 3.0]))
        @test isstructequal(res, ref)
    end
    @testset "Finch.RepeatRLELevel{0.0, Int8} constructors" begin
        ...
        @test isstructequal(res, ref)
        res = Fiber(Finch.RepeatRLELevel{0.0, Int8, Int64}(6, [1, 4], Int8[1, 4, 6], [0.0, 2.0, 3.0]))
        @test isstructequal(res, ref)
        res = Fiber(Finch.RepeatRLELevel{0.0, Int8, Int64, Float64}(6, [1, 4], Int8[1, 4, 6], [0.0, 2.0, 3.0]))
        @test isstructequal(res, ref)
    end
    @testset "Finch.RepeatRLELevel{0.0, Int8, Int8} constructors" begin
