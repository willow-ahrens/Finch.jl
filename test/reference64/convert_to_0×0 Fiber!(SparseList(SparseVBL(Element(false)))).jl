begin
                        ...
                        while true
                            ...
                            if ref_lvl_2_i < phase_stop_7
                                ...
                                if ref_lvl_2_i == phase_stop_9
                                    ...
                                    tmp_lvl_idx_2[tmp_lvl_2_ros_2] = (tmp_lvl_2_i_prev_2 = phase_stop_9)
                                    tmp_lvl_2_qos_2 += 1
                                    tmp_lvl_ofs[tmp_lvl_2_ros_2 + 1] = tmp_lvl_2_qos_2
                                    tmp_lvl_2_prev_pos = tmp_lvl_qos
                                    ref_lvl_2_q += 1
    ...
    (tmp = Fiber((SparseListLevel){Int64}((SparseVBLLevel){Int64}(tmp_lvl_3, ref_lvl_2.shape, tmp_lvl_ptr_2, tmp_lvl_idx_2, tmp_lvl_ofs), ref_lvl.shape, tmp_lvl_ptr, tmp_lvl_idx)),)
end
