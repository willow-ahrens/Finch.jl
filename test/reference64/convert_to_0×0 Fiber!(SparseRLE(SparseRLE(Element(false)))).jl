begin
        ...
        while true
            ...
            if ref_lvl_i < phase_stop
                ...
                if ref_lvl_i == phase_stop_6
                        ...
                        while true
                            ...
                            if ref_lvl_2_i < phase_stop_7
                                ...
                                if ref_lvl_2_i == phase_stop_9
                                    ...
                                    tmp_lvl_2_val[tmp_lvl_2_qos_2] = ref_lvl_3_val_2
                                    tmp_lvldirty = true
                                    tmp_lvl_left_2[tmp_lvl_2_qos_2] = phase_stop_9
                                    tmp_lvl_right_2[tmp_lvl_2_qos_2] = phase_stop_9
                                    tmp_lvl_2_qos_2 += 1
                                    tmp_lvl_2_prev_pos = tmp_lvl_qos
                                    ref_lvl_2_q += 1
                                end
                    ...
                    if tmp_lvldirty
                        tmp_lvl_left[tmp_lvl_qos] = phase_stop_6
                        tmp_lvl_right[tmp_lvl_qos] = phase_stop_6
                        tmp_lvl_qos += 1
                    end
                    ref_lvl_q += 1
                end
    ...
    (tmp = Fiber((SparseRLELevel){Int64}((SparseRLELevel){Int64}(tmp_lvl_3, ref_lvl_2.shape, tmp_lvl_ptr_2, tmp_lvl_left_2, tmp_lvl_right_2), ref_lvl.shape, tmp_lvl_ptr, tmp_lvl_left, tmp_lvl_right)),)
end
