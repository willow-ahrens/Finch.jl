begin
    ...
    return (tmp = Tensor((SparseRLELevel){Int64}((SparseRLELevel){Int64}(tmp_lvl_3, ref_lvl_2.shape, tmp_lvl_ptr_2, tmp_lvl_left_2, tmp_lvl_right_2), ref_lvl.shape, tmp_lvl_ptr, tmp_lvl_left, tmp_lvl_right)),)
    nothing
end
