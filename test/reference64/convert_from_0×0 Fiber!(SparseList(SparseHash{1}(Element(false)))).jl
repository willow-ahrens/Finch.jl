begin
        ...
        while true
            ...
            if tmp_lvl_i < phase_stop
                ...
                if phase_stop_3 >= 1
                    ...
                    while true
                        ...
                        if tmp_lvl_2_i < phase_stop_3
                            ...
                            phase_stop_5 = min(phase_stop_3, tmp_lvl_2_i)
                ...
                if tmp_lvl_i == phase_stop_6
                    ...
                    phase_stop_7 = min(tmp_lvl_2_i_stop, tmp_lvl_2.shape[1])
                    if phase_stop_7 >= 1
                        while tmp_lvl_2_q + 1 < tmp_lvl_2_q_stop && (((tmp_lvl_srt[tmp_lvl_2_q])[1])[2])[1] < 1
                            tmp_lvl_2_q += 1
                        end
                        while true
                            ...
                            if tmp_lvl_2_i < phase_stop_7
                                ...
                                phase_stop_9 = min(tmp_lvl_2_i, phase_stop_7)
                                if tmp_lvl_2_i == phase_stop_9
                                    tmp_lvl_3_val_2 = tmp_lvl_2_val[(tmp_lvl_2.srt[tmp_lvl_2_q])[2]]
                                    if res_lvl_2_qos_2 > res_lvl_2_qos_stop
                                        res_lvl_2_qos_stop = max(res_lvl_2_qos_stop << 1, 1)
                                        Finch.resize_if_smaller!(res_lvl_idx_2, res_lvl_2_qos_stop)
    ...
    (res = Fiber((SparseListLevel){Int64}((SparseListLevel){Int64}(res_lvl_3, tmp_lvl_2.shape[1], res_lvl_ptr_2, res_lvl_idx_2), tmp_lvl.shape, res_lvl_ptr, res_lvl_idx)),)
end
