begin
    ...
    if phase_stop >= 1
        ...
        while true
            ...
            if tmp_lvl_i < phase_stop
                ...
                phase_stop_3 = min(tmp_lvl_2_i_end, tmp_lvl_2.shape)
                if phase_stop_3 >= 1
                    i = 1
                    ...
                    while true
                        ...
                        if tmp_lvl_2_i_stop < phase_stop_3
                            phase_start = max(i_start_2, tmp_lvl_2_i_start)
                            if tmp_lvl_2_i_stop >= phase_start
                                tmp_lvl_3_val = tmp_lvl_2_val[tmp_lvl_2_q]
                                for i_8 = phase_start:tmp_lvl_2_i_stop
                            ...
                            phase_stop_7 = min(phase_stop_3, tmp_lvl_2_i_stop)
                ...
                if tmp_lvl_i == phase_stop_10
                    ...
                    phase_stop_11 = min(tmp_lvl_2_i_end, tmp_lvl_2.shape)
                    if phase_stop_11 >= 1
                        i = 1
                        if tmp_lvl_right[tmp_lvl_2_q] < 1
                            tmp_lvl_2_q = Finch.scansearch(tmp_lvl_right, 1, tmp_lvl_2_q, tmp_lvl_2_q_stop - 1)
                        ...
                        while true
                            ...
                            tmp_lvl_2_i_start = tmp_lvl_left[tmp_lvl_2_q]
                            tmp_lvl_2_i_stop = tmp_lvl_right[tmp_lvl_2_q]
                            if tmp_lvl_2_i_stop < phase_stop_11
                                phase_start_4 = max(tmp_lvl_2_i_start, i_start_6)
                                if tmp_lvl_2_i_stop >= phase_start_4
                                    tmp_lvl_3_val_3 = tmp_lvl_2_val[tmp_lvl_2_q]
                                    for i_17 = phase_start_4:tmp_lvl_2_i_stop
                                ...
                                phase_stop_15 = min(tmp_lvl_2_i_stop, phase_stop_11)
                                phase_start_5 = max(tmp_lvl_2_i_start, i_start_6)
                                ...
                                tmp_lvl_2_q += phase_stop_15 == tmp_lvl_2_i_stop
                                i = phase_stop_15 + 1
                                break
                            end
                        end
    ...
    (res = Fiber((SparseListLevel){Int64}((SparseListLevel){Int64}(res_lvl_3, tmp_lvl_2.shape, res_lvl_ptr_2, res_lvl_idx_2), tmp_lvl.shape, res_lvl_ptr, res_lvl_idx)),)
end
