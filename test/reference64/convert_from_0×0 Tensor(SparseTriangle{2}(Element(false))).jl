begin
        ...
        for j_5 = 1:phase_stop
            ...
            if phase_stop_2 >= 1
                for i_5 = 1:phase_stop_2
                    ...
                    tmp_lvl_2_val = tmp_lvl_val[-1 + tmp_lvl_s + i_5]
    ...
    result = something(nothing, (res = Tensor((SparseListLevel){Int64}((SparseListLevel){Int64}(res_lvl_3, tmp_lvl.shape, res_lvl_ptr_2, res_lvl_idx_2), tmp_lvl.shape, res_lvl_ptr, res_lvl_idx)),))
