@testset "typical" begin
    ...
    let
        ...
        @test check_println("typical/inplace_sparse_add.txt", String(take!(io)))
    end
    ...
    let
        ...
        @test check_println("typical/spmv_sparsematrixcsc.txt", String(take!(io)))
    end
    ...
    let
        ...
        @test check_println("typical/spmv_csc.txt", String(take!(io)))
    end
    ...
    let
        ...
        @test check_println("typical/transpose_csc_to_coo.txt", String(take!(io)))
    end
    ...
    let
        ...
        @test check_println("typical/merge_gallop.txt", String(take!(io)))
        ...
        @test check_println("typical/merge_leadfollow.txt", String(take!(io)))
        ...
        @test check_println("typical/merge_twofinger.txt", String(take!(io)))
        ...
        @test check_println("typical/stats_example.txt", String(take!(io)))
    end
end