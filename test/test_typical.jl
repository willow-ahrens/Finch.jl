@testset "typical" begin
    ...
    let
        ...
        @test check_output("typical/inplace_sparse_add.txt", String(take!(io)))
    end
    ...
    let
        ...
        @test check_output("typical/spmv_sparsematrixcsc.txt", String(take!(io)))
    end
    ...
    let
        ...
        @test check_output("typical/spmv_csc.txt", String(take!(io)))
    end
    ...
    let
        ...
        @test check_output("typical/transpose_csc_to_coo.txt", String(take!(io)))
    end
    ...
    let
        ...
        @test check_output("typical/merge_gallop.txt", String(take!(io)))
        ...
        @test check_output("typical/merge_leadfollow.txt", String(take!(io)))
        ...
        @test check_output("typical/merge_twofinger.txt", String(take!(io)))
        ...
        @test check_output("typical/stats_example.txt", String(take!(io)))
    end
end