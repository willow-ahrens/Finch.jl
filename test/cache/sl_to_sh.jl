@inbounds begin
        ...
        (B = Fiber((Finch.SparseHashLevel){1, Tuple{Int64}, Int64, Dict{Tuple{Int64, Tuple{Int64}}, Int64}}((A_lvl.I,), B_lvl.tbl, B_lvl.pos, B_lvl.srt, B_lvl_2), (Finch.Environment)(; name = :B)),)
    end
