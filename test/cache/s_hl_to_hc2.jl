@inbounds begin
        ...
        (B = Fiber((Finch.HollowCooLevel){2, Tuple{Int64, Int64}, Int64, Tuple{Vector{Int64}, Vector{Int64}}}((A_lvl_I, A_lvl_2_I), B_lvl.tbl, B_lvl.pos, B_lvl_2), (Finch.Environment)(; name = :B)),)
    end
