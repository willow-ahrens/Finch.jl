@inbounds begin
        ...
        (B = Fiber((Finch.HollowCooLevel){2, Tuple{Int64, Int64}, Int64, Tuple{Vector{Int64}, Vector{Int64}}}(B_lvl_I, B_lvl.tbl, B_lvl.pos, B_lvl_2), (Finch.Environment)(; name = :B)),)
    end
