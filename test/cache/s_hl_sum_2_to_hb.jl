@inbounds begin
        ...
        B_lvlq_start = (1 - 1) * A_lvl_2_I + 1
        B_lvlq_stop = 1A_lvl_2_I
        ...
        (B = Fiber((Finch.HollowByteLevel){Int64, Int64, Int64}(A_lvl_2_I, B_lvl.P, B_lvl.tbl, B_lvl.srt, B_lvl.srt_stop, B_lvl.pos, B_lvl_2), (Finch.Environment)(; name = :B)),)
    end
