@inbounds begin
        ...
        phase_stop = min(selects - 1, A_lvl_i1, A_lvl_I)
        ...
        phase_stop_2 = min(selects - 1, A_lvl_I)
        ...
        phase_stop_3 = min(A_lvl_i1, selects, A_lvl_I)
        ...
        phase_stop_5 = min(selects, A_lvl_I)
        ...
        phase_stop_6 = min(A_lvl_i1, A_lvl_I)
        if phase_stop_6 >= phase_start_6
            s_8 = s
            s = phase_stop_6 + 1
        end
        s_start = s
        phase_stop_7 = A_lvl_I
        s_9 = s
        s = phase_stop_7 + 1
