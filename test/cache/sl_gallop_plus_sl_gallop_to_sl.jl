@inbounds begin
            ...
            while i <= phase_stop
                ...
                if phase_stop_2 >= phase_start_2
                    ...
                    elseif phase_stop_2 == A_lvl_i
                        i = phase_start_2
                        while B_lvl_q + 1 < B_lvl_q_stop && B_lvl.idx[B_lvl_q] < phase_start_2
                            B_lvl_q += 1
                        end
                        ...
                        if B_lvl_i == phase_stop_4
                            ...
                            C_lvl_isdefault = false
                            C_lvl_isdefault = false
                            C_lvl_2_val = (+)(A_lvl_2_val, B_lvl_2_val, C_lvl_2_val)
                            C_lvl_2.val[C_lvl_q] = C_lvl_2_val
                            if !C_lvl_isdefault
                                C_lvl_idx_alloc < C_lvl_q && (C_lvl_idx_alloc = (Finch).regrow!(C_lvl.idx, C_lvl_idx_alloc, C_lvl_q))
                    ...
                    elseif phase_stop_2 == B_lvl_i
                        i = phase_start_2
                        while A_lvl_q + 1 < A_lvl_q_stop && A_lvl.idx[A_lvl_q] < phase_start_2
                            A_lvl_q += 1
                        end
                        while i <= phase_stop_2 - 1
                            i_start_5 = i
        ...
        phase_stop_8 = (min)(B_lvl_i1, i_stop)
            ...
            while i <= phase_stop_8
                ...
                if phase_stop_9 >= phase_start_9
                    ...
                    if phase_stop_9 == B_lvl_i
                        ...
                        i = phase_start_9
                        while B_lvl_q + 1 < B_lvl_q_stop && B_lvl.idx[B_lvl_q] < phase_start_9
                            B_lvl_q += 1
                        end
        ...
        phase_stop_11 = (min)(A_lvl_i1, i_stop)
