@inbounds begin
        ...
        if i_start <= i_step
            ...
            while i_start_2 <= i_step
                A_lvl_i = A_lvl.idx[A_lvl_q]
                B_lvl_i = B_lvl.idx[B_lvl_q]
                i_step_2 = min(max(A_lvl_i, B_lvl_i), i_step)
                ...
                elseif i_step_2 == B_lvl_i
                    B_lvl_2_val = B_lvl_2.val[B_lvl_q]
                    i_start_3 = i_step_2
                    while A_lvl_q < A_lvl_q_stop && A_lvl.idx[A_lvl_q] < i_start_3
                        A_lvl_q += 1
                    end
                    A_lvl_i = A_lvl.idx[A_lvl_q]
                    if i_start_3 == A_lvl_i
                        A_lvl_2_val = A_lvl_2.val[A_lvl_q]
                        i_2 = i_step_2
                        C_lvl_2_val_alloc < C_lvl_q && (C_lvl_2_val_alloc = (Finch).refill!(C_lvl_2.val, 0.0, C_lvl_2_val_alloc, C_lvl_q))
                        C_lvl_isdefault = true
                ...
                elseif i_step_2 == A_lvl_i
                    A_lvl_2_val = A_lvl_2.val[A_lvl_q]
                    i_start_4 = i_step_2
                    while B_lvl_q < B_lvl_q_stop && B_lvl.idx[B_lvl_q] < i_start_4
                        B_lvl_q += 1
                    end
                    B_lvl_i = B_lvl.idx[B_lvl_q]
                    if i_start_4 == B_lvl_i
                        B_lvl_2_val = B_lvl_2.val[B_lvl_q]
                        i_3 = i_step_2
                        C_lvl_2_val_alloc < C_lvl_q && (C_lvl_2_val_alloc = (Finch).refill!(C_lvl_2.val, 0.0, C_lvl_2_val_alloc, C_lvl_q))
                        C_lvl_isdefault = true
                    ...
                    i_start_5 = i_start_2
                    while i_start_5 <= i_step_2
                        A_lvl_i = A_lvl.idx[A_lvl_q]
                        B_lvl_i = B_lvl.idx[B_lvl_q]
                        i_step_3 = min(A_lvl_i, B_lvl_i, i_step_2)
                        if i_step_3 == A_lvl_i && i_step_3 == B_lvl_i
                            A_lvl_2_val = A_lvl_2.val[A_lvl_q]
                            B_lvl_2_val = B_lvl_2.val[B_lvl_q]
                            i_4 = i_step_3
                            C_lvl_2_val_alloc < C_lvl_q && (C_lvl_2_val_alloc = (Finch).refill!(C_lvl_2.val, 0.0, C_lvl_2_val_alloc, C_lvl_q))
                            ...
                            A_lvl_q += 1
                            B_lvl_q += 1
                        elseif i_step_3 == B_lvl_i
                            B_lvl_2_val = B_lvl_2.val[B_lvl_q]
                            B_lvl_q += 1
                        elseif i_step_3 == A_lvl_i
                            A_lvl_2_val = A_lvl_2.val[A_lvl_q]
                            A_lvl_q += 1
                        else
                        end
                        i_start_5 = i_step_3 + 1
                    end
                end
