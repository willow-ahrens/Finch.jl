if isfile(joinpath(@__DIR__, "test_embed_simple"))
    @testset "embed" begin
        ...
        @test check_println("embed/test_embed_simple.txt", String(take!(io)))
        ...
        @test check_println("embed/test_embed_not_initialized.txt", String(take!(io)))
        ...
        @test check_println("embed/test_embed_not_rooted.txt", String(take!(io)))
    end
end