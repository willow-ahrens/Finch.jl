begin
    ...
    result = something(nothing, (tmp = Tensor((DenseLevel){Int32}((SparseHashLevel){1, Tuple{Int32}}(tmp_lvl_3, (ref_lvl_2.shape,), tmp_lvl_ptr, tmp_lvl_tbl, tmp_lvl_srt), ref_lvl.shape)),))
    result
end
