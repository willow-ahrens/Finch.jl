            ...
            while true
                ...
                if A_lvl_2_i < phase_stop
                    ...
                    if A_lvl_2_i == phase_stop_7
                        A_lvl_3_val = A_lvl_2_val[A_lvl_2_q]
                        A_lvl_q_3 = (1 - 1) * A_lvl.shape + phase_stop_7
                        A_lvl_2_q_2 = A_lvl_ptr[A_lvl_q_2]
                        A_lvl_2_q_stop_2 = A_lvl_ptr[A_lvl_q_2 + 1]
                        if A_lvl_2_q_2 < A_lvl_2_q_stop_2
                            A_lvl_2_i1_2 = A_lvl_idx[A_lvl_2_q_stop_2 - 1]
                        ...
                        phase_stop_8 = min(A_lvl_2.shape, A_lvl_2_i1_2, A_lvl_2_i1_4)
                        if phase_stop_8 >= 1
                            k = 1
                            if A_lvl_idx[A_lvl_2_q_2] < 1
                                A_lvl_2_q_2 = Finch.scansearch(A_lvl_idx, 1, A_lvl_2_q_2, A_lvl_2_q_stop_2 - 1)
                            ...
                            while k <= phase_stop_8
                                ...
                                phase_stop_9 = min(A_lvl_2_i_2, A_lvl_2_i_4, phase_stop_8)
                                if A_lvl_2_i_2 == phase_stop_9 && A_lvl_2_i_4 == phase_stop_9
                                    ...
                                    A_lvl_2_q_2 += 1
                                    A_lvl_2_q_4 += 1
                                elseif A_lvl_2_i_4 == phase_stop_9
                                    A_lvl_2_q_4 += 1
                                elseif A_lvl_2_i_2 == phase_stop_9
                                    A_lvl_2_q_2 += 1
                                end
                                k = phase_stop_9 + 1
                            end
