begin
    ...
    if phase_stop >= 1
        ...
        while true
            ...
            if tmp_lvl_i < phase_stop
                ...
                tmp_lvl_2_subtbl = table_query(tmp_lvl_tbl, tmp_lvl_q)
                sugar_1 = subtable_init(tmp_lvl_tbl, tmp_lvl_2_subtbl)
                tmp_lvl_2_i = sugar_1[1]
                tmp_lvl_2_i1 = sugar_1[2]
                tmp_lvl_2_state = sugar_1[3]
                phase_stop_3 = min(tmp_lvl_2_i1, tmp_lvl_2.shape)
                if phase_stop_3 >= 1
                    if tmp_lvl_2_i < 1
                        sugar_2 = subtable_seek(tmp_lvl_tbl, tmp_lvl_2_subtbl, tmp_lvl_2_state, tmp_lvl_2_i, 1)
                        tmp_lvl_2_state = sugar_2[2]
                    end
                    while true
                        sugar_3 = subtable_get(tmp_lvl_tbl, tmp_lvl_2_subtbl, tmp_lvl_2_state)
                        tmp_lvl_2_i = sugar_3[1]
                        tmp_lvl_2_q = sugar_3[2]
                        if tmp_lvl_2_i < phase_stop_3
                            ...
                            tmp_lvl_2_state = subtable_next(tmp_lvl_tbl, tmp_lvl_2_subtbl, tmp_lvl_2_state)
                        else
                ...
                if tmp_lvl_i == phase_stop_7
                    ...
                    res_lvl_2_prev_pos < res_lvl_qos || throw(FinchProtocolError("SparseListLevels cannot be updated multiple times"))
                    tmp_lvl_2_subtbl = table_query(tmp_lvl_tbl, tmp_lvl_q)
                    sugar_4 = subtable_init(tmp_lvl_tbl, tmp_lvl_2_subtbl)
                    tmp_lvl_2_i = sugar_4[1]
                    tmp_lvl_2_i1 = sugar_4[2]
                    tmp_lvl_2_state = sugar_4[3]
                    phase_stop_8 = min(tmp_lvl_2_i1, tmp_lvl_2.shape)
                    if phase_stop_8 >= 1
                        if tmp_lvl_2_i < 1
                            sugar_5 = subtable_seek(tmp_lvl_tbl, tmp_lvl_2_subtbl, tmp_lvl_2_state, tmp_lvl_2_i, 1)
                            tmp_lvl_2_state = sugar_5[2]
                        end
                        while true
                            sugar_6 = subtable_get(tmp_lvl_tbl, tmp_lvl_2_subtbl, tmp_lvl_2_state)
                            tmp_lvl_2_i = sugar_6[1]
                            tmp_lvl_2_q = sugar_6[2]
    ...
    result = something(nothing, (res = Tensor((SparseListLevel){Int32}((SparseListLevel){Int32}(res_lvl_3, tmp_lvl_2.shape, res_lvl_ptr_2, res_lvl_idx_2), tmp_lvl.shape, res_lvl_ptr, res_lvl_idx)),))
    result
end
