begin
    ...
    if phase_stop >= i_start
        ...
        while i <= phase_stop
            ...
            if A_lvl_i == phase_stop_2
                ...
                j_start = j
                phase_stop_11 = (min)(s_3, F_lvl.shape)
                if phase_stop_11 >= j_start
                    j_16 = j
                    j = phase_stop_11 + 1
                end
                j_start = j
                phase_stop_12 = (min)(F_lvl.shape, (+)(A_lvl.shape, s_3))
    ...
    (C = Fiber((Finch.SparseListLevel){Int64, Int32}(C_lvl_2, A_lvl.shape, C_lvl.ptr, C_lvl.idx)),)
end
