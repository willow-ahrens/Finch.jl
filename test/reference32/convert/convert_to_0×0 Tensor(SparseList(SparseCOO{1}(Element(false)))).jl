begin
    ...
    result = (tmp = Tensor((SparseListLevel){Int32}((SparseCOOLevel){1, Tuple{Int32}}(tmp_lvl_3, (ref_lvl_2.shape,), tmp_lvl_ptr_2, (tmp_lvl_tbl1,)), ref_lvl.shape, tmp_lvl_ptr, tmp_lvl_idx)),)
    result
end
