begin
    ...
    result = (tmp = Tensor((SparseListLevel){Int32}((SparseRLELevel){Int32}(tmp_lvl_3, ref_lvl_2.shape, tmp_lvl_ptr_2, tmp_lvl_left, tmp_lvl_right, tmp_lvl_4), ref_lvl.shape, tmp_lvl_ptr, tmp_lvl_idx)),)
    result
end
