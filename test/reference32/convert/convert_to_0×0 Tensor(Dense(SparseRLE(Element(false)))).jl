begin
    ...
    resize!(tmp_lvl_2_val_2, qos_stop)
    Finch.resize_if_smaller!(tmp_lvl_2_val, qos_stop)
    Finch.fill_range!(tmp_lvl_2_val, false, 1, qos_stop)
    q = 1
    q_2 = 1
    for p_2 = 1:ref_lvl.shape
    ...
    result = (tmp = Tensor((DenseLevel){Int32}((SparseRLELevel){Int32}(tmp_lvl_3, ref_lvl_2.shape, tmp_lvl_ptr, tmp_lvl_left, tmp_lvl_right, tmp_lvl_4), ref_lvl.shape)),)
    result
end
