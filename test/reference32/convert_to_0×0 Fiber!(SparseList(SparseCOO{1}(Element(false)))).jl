begin
    ...
    if phase_stop >= 1
        ...
        while true
            ...
            if ref_lvl_i < phase_stop
                ...
                if (tmp_lvl_2_q - tmp_lvl_2_qos_fill) - 1 > 0
                        ...
                        while true
                            ...
                            if ref_lvl_2_i < phase_stop_7
                                ...
                                if ref_lvl_2_i == phase_stop_9
                                    ...
                                    tmp_lvl_2_val[tmp_lvl_2_q_2] = ref_lvl_3_val_2
                                    tmp_lvl_2_prev_coord_3 < (phase_stop_9,) || throw(FinchProtocolError("SparseCOOLevels cannot be updated multiple times"))
                                    tmp_lvl_2_prev_coord_3 = (phase_stop_9,)
                                    tmp_lvldirty = true
                                    tmp_lvl_tbl1[tmp_lvl_2_q_2] = phase_stop_9
                                    tmp_lvl_2_q_2 += 1
                                    ref_lvl_2_q += 1
                                end
                                break
    ...
    (tmp = Fiber((SparseListLevel){Int32}((SparseCOOLevel){1, Tuple{Int32}}(tmp_lvl_3, (ref_lvl_2.shape,), tmp_lvl_ptr_2, (tmp_lvl_tbl1,)), ref_lvl.shape, tmp_lvl_ptr, tmp_lvl_idx)),)
end
