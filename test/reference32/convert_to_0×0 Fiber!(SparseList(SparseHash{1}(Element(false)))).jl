begin
                        ...
                        while true
                            ...
                            if ref_lvl_2_i < phase_stop_7
                                ...
                                if ref_lvl_2_i == phase_stop_9
                                    ref_lvl_3_val_2 = ref_lvl_2_val[ref_lvl_2_q]
                                    tmp_lvl_2_key_2 = (tmp_lvl_qos, (phase_stop_9,))
                                    tmp_lvl_2_q_2 = get(tmp_lvl_tbl, tmp_lvl_2_key_2, tmp_lvl_2_qos_fill + 1)
                                    if tmp_lvl_2_q_2 > tmp_lvl_2_qos_stop
                                        tmp_lvl_2_qos_stop = max(tmp_lvl_2_qos_stop << 1, 1)
                                        Finch.resize_if_smaller!(tmp_lvl_2_val, tmp_lvl_2_qos_stop)
    ...
    (tmp = Fiber((SparseListLevel){Int32}((SparseHashLevel){1, Tuple{Int32}}(tmp_lvl_3, (ref_lvl_2.shape,), tmp_lvl_ptr_2, tmp_lvl_tbl, tmp_lvl_srt), ref_lvl.shape, tmp_lvl_ptr, tmp_lvl_idx)),)
end
