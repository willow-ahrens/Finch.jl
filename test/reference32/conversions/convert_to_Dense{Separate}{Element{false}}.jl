begin
    ...
    Finch.fill_range!(pointer_to_lvl_5_val, false, 1, pointer_to_lvl_5.shape)
    ...
    result = (tmp = Tensor((SeparateLevel){DenseLevel{Int32, ElementLevel{false, Bool, Int32, Vector{Bool}}}, Vector{DenseLevel{Int32, ElementLevel{false, Bool, Int32, Vector{Bool}}}}}((DenseLevel){Int32}(tmp_lvl_3, ref_lvl.shape), tmp_lvl.val)),)
    result
end
