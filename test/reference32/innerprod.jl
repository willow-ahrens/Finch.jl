begin
    ...
    for j_4 = 1:A_lvl.shape
        ...
        for i_4 = 1:A_lvl.shape
            ...
            k_start = k
            phase_stop_4 = (min)(A_lvl_2.shape, A_lvl_2_i1_2)
            if phase_stop_4 >= k_start
                k_8 = k
                k = phase_stop_4 + 1
            end
            k_start = k
            if A_lvl_2.shape >= k_start
                k_9 = k
                k = A_lvl_2.shape + 1
            end
    ...
    (B = Fiber((Finch.DenseLevel){Int32}((Finch.SparseListLevel){Int32, Int32}(B_lvl_3, A_lvl.shape, B_lvl_2.ptr, B_lvl_2.idx), A_lvl.shape)),)
end
