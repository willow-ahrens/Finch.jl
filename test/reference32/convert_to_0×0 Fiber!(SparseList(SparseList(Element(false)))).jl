begin
                        ...
                        while true
                            ...
                            if ref_lvl_2_i < phase_stop_7
                                ...
                                if ref_lvl_2_i == phase_stop_9
                                    ...
                                    tmp_lvl_2_val[tmp_lvl_2_qos_2] = ref_lvl_3_val_2
                                    tmp_lvldirty = true
                                    tmp_lvl_idx_2[tmp_lvl_2_qos_2] = phase_stop_9
                                    tmp_lvl_2_qos_2 += 1
                                    tmp_lvl_2_prev_pos = tmp_lvl_qos
                                    ref_lvl_2_q += 1
                                end
    ...
    resize!(tmp_lvl_idx_2, qos_2)
    resize!(tmp_lvl_2_val, qos_2)
    (tmp = Fiber((SparseListLevel){Int32}((SparseListLevel){Int32}(tmp_lvl_3, ref_lvl_2.shape, tmp_lvl_ptr_2, tmp_lvl_idx_2), ref_lvl.shape, tmp_lvl_ptr, tmp_lvl_idx)),)
end
