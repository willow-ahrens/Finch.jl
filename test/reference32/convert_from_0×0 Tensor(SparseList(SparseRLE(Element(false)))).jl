                ...
                if phase_stop_3 >= 1
                    ...
                    while true
                        ...
                        if tmp_lvl_2_i_stop < phase_stop_3
                            phase_stop_5 = min(tmp_lvl_2_i_stop, -1 + tmp_lvl_2_i_start)
                            if phase_stop_5 >= i
                                i = phase_stop_5 + 1
                            end
                            phase_start_4 = max(i, tmp_lvl_2_i_start)
                            ...
                            phase_stop_8 = min(-1 + tmp_lvl_2_i_start, phase_stop_7)
                            i = phase_stop_8 + 1
                            phase_start_7 = max(tmp_lvl_2_i_start, i)
                    ...
                    if phase_stop_12 >= 1
                        ...
                        while true
                            ...
                            if tmp_lvl_2_i_stop < phase_stop_12
                                phase_stop_14 = min(-1 + tmp_lvl_2_i_start, tmp_lvl_2_i_stop)
                                if phase_stop_14 >= i
                                    i = phase_stop_14 + 1
                                end
                                phase_start_12 = max(tmp_lvl_2_i_start, i)
                                ...
                                phase_stop_17 = min(-1 + tmp_lvl_2_i_start, phase_stop_16)
                                i = phase_stop_17 + 1
                                phase_start_15 = max(tmp_lvl_2_i_start, i)
