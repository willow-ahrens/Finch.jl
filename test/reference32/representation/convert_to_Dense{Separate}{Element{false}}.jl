quote
    ...
    (tmp = Tensor((SeparateLevel){DenseLevel{Int32, ElementLevel{false, Bool, Int32, Vector{Bool}}}, Vector{DenseLevel{Int32, ElementLevel{false, Bool, Int32, Vector{Bool}}}}}((DenseLevel){Int32}(tmp_lvl_3, ref_lvl.shape), tmp_lvl_val)),)
end
