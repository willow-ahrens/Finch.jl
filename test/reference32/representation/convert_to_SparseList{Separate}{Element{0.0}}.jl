quote
            ...
            if ref_lvl_i < phase_stop
                ...
                if tmp_lvl_qos > tmp_lvl_qos_stop
                    ...
                    for pos = tmp_lvl_qos:tmp_lvl_qos_stop
                        ...
                        Finch.fill_range!(pointer_to_lvl_val, 0.0, 1, 1)
                ...
                Finch.fill_range!(pointer_to_lvl_3_val, 0.0, 1, 1)
                ...
                if ref_lvl_i == phase_stop_3
                    ...
                    if tmp_lvl_qos > tmp_lvl_qos_stop
                        ...
                        for pos_2 = tmp_lvl_qos:tmp_lvl_qos_stop
                            ...
                            Finch.fill_range!(pointer_to_lvl_5_val, 0.0, 1, 1)
                    ...
                    Finch.fill_range!(pointer_to_lvl_7_val, 0.0, 1, 1)
    ...
    result = (tmp = Tensor((SparseListLevel){Int32}((SeparateLevel){ElementLevel{0.0, Float64, Int32, Vector{Float64}}, Vector{ElementLevel{0.0, Float64, Int32, Vector{Float64}}}}(tmp_lvl_3, tmp_lvl_2.val), ref_lvl.shape, tmp_lvl_ptr, tmp_lvl_idx)),)
    result
end
