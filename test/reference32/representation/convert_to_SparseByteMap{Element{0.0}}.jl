quote
    ...
    for tmp_lvl_r = 1:tmp_lvl_qos_fill
        ...
        Finch.fill_range!(tmp_lvl_val, 0.0, tmp_lvl_q, tmp_lvl_q)
    end
    tmp_lvl_qos_fill = 0
    tmp_lvl_ptr[1] = 1
    ...
    Finch.fill_range!(tmp_lvl_val, 0.0, tmp_lvlold, tmp_lvlq_stop)
    ...
    result = (tmp = Tensor((SparseByteMapLevel){Int32}(tmp_lvl_2, ref_lvl.shape, tmp_lvl_ptr, tmp_lvl_tbl, tmp_lvl_srt)),)
    result
end
