...
@add_arg_table! s begin
    ...
    "suites"
        nargs = '*'
        default = ["all"]
        help = "names of test suites to run, from: print, representation, constructors, conversions, merges, index, typical, kernels, issues, base, apps, fileio, docs, debug, continuous, algebra, moveto."
end
