...
(ctx::Stylize{LowerJulia})(node::Jumper) = ctx.root isa Chunk ? JumperStyle() : DefaultStyle()
...
(ctx::Stylize{LowerJulia})(node::Jump) = ctx.root isa Chunk ? PhaseStyle() : DefaultStyle()
