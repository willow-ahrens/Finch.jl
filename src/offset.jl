...
Finch.virtual_resize!(arr::VirtualStaticOffset, ctx::Finch.LowerJulia, dim) = VirtualStaticOffset(;kwfields(arr)..., dim=dim)
...
Finch.virtual_resize!(arr::VirtualOffset, ctx::Finch.LowerJulia, dim1, dim2) = arr
