...
get_level_reader(lvl::VirtualDenseLevel, ctx, p, protos...) = 
    get_level_updater(lvl, ctx, p, protos...)
function get_level_updater(lvl::VirtualDenseLevel, ctx, p, ::Union{Nothing, Follow, Laminate, Extrude}, protos...)
    tag = lvl.ex
    Ti = lvl.Ti
