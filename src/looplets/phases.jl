...
function lower(root::FinchNode, ctx::AbstractCompiler,  style::PhaseStyle)
    if root.kind === loop
        ...
        #display(ctx.constraints)
        #print("rootext getstart : "); display(getstart(root.ext))
        #print("rootext getstop  : "); display(getstop(root.ext))
        #print("ext_2 getstart : "); display(getstart(ext_2))
        #print("ext_2 getstop  : "); display(getstop(ext_2))
        #print("intersect getstart : "); display(getstart(ext_3))
        #print("intersect getstop  : "); display(getstop(ext_3))
