...
getsites(fbr::VirtualFiber{VirtualRepeatRLEDiffLevel}) =
    [envdepth(fbr.env) + 1, ]

function getsize(fbr::VirtualFiber{VirtualRepeatRLEDiffLevel}, ctx, mode)
...
function setsize!(fbr::VirtualFiber{VirtualRepeatRLEDiffLevel}, ctx, mode, dim)
